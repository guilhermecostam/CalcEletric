...
public class OhmLaw_calcRes extends javax.swing.JFrame {

    public OhmLaw_calcRes() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OhmLaw_calcRes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
