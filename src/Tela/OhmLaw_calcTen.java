...
public class OhmLaw_calcTen extends javax.swing.JFrame {

    public OhmLaw_calcTen() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    private void initComponents() {
        ...
        calcular.setText("Calcular Tensão");
        ...
        jLabel1.setText("Digite a corrente:");
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        Obj_calc.setI(Double.parseDouble(txt1.getText()));
                txt3.setText(Obj_calc.calcTen()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OhmLaw_calcTen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
