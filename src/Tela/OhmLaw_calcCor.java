...
public class OhmLaw_calcCor extends javax.swing.JFrame {

    public OhmLaw_calcCor() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    private void initComponents() {
        ...
        calcular.setText("Calcular Corrente");
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        Obj_calc.setR(Double.parseDouble(txt2.getText()));
        Obj_calc.setV(Double.parseDouble(txt1.getText()));
                txt3.setText(Obj_calc.calcCor()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OhmLaw_calcCor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
