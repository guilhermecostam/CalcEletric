package Tela;
import calcu.Class_ohmLaw2;

public class OhmLaw2_calc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calcular.setText("Calcular Resistência");
        ...
        jLabel1.setText("Digite a resistividade do material:");

        jLabel2.setText("Digite a área transversal:");

        jLabel3.setText("Digite o comprimento do material:");
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        // TODO add your handling code here:
        Class_ohmLaw2 Obj_calc=new Class_ohmLaw2();
        Obj_calc.setResMa(Double.parseDouble(txt1.getText()));
        Obj_calc.setAreaTra(Double.parseDouble(txt2.getText()));
        Obj_calc.setComp(Double.parseDouble(txt3.getText()));
                txt4.setText(Obj_calc.ohmLaw2()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OhmLaw2_calc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
