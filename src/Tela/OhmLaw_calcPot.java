package Tela;
import calcu.Class_ohmLaw;

public class OhmLaw_calcPot extends javax.swing.JFrame {

    public OhmLaw_calcPot() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    private void initComponents() {
        ...
        calcular.setText("Calcular Potência");
        ...
        jLabel1.setText("Digite a tensão:");

        jLabel2.setText("Digite a corrente:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(num7, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        // TODO add your handling code here:
        Class_ohmLaw Obj_calc=new Class_ohmLaw();
        Obj_calc.setI(Double.parseDouble(txt2.getText()));
        Obj_calc.setV(Double.parseDouble(txt1.getText()));
                txt3.setText(Obj_calc.calcPot()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OhmLaw_calcPot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
