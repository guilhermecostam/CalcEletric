...
public class Conv_decTobin extends javax.swing.JFrame {

    public Conv_decTobin() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    private void converterBinarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_converterBinarioActionPerformed
        ...
        Obj_conv.setDec(Double.parseDouble(txt.getText()));
        txt.setText(Obj_conv.DecToBin()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conv_decTobin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
