...
public class Conv_binTohexa extends javax.swing.JFrame {

    public Conv_binTohexa() {
        initComponents();
    }
    public double acum;
    public double valor;
    ...
    private void initComponents() {
        ...
        converterHexa.setText("Converter para Hexa");
    ...
    private void converterHexaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_converterHexaActionPerformed
        ...
        txt.setText(Obj_conv.BinToHexa()+"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conv_binTohexa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
